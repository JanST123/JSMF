...
class Memcached implements CacheInterface {
  ...
  public static function connect() :bool {
    ...
    if (Config::has('cache.memcache.host')) {
      ...
      self::$_mc->setOption(\Memcached::OPT_SERIALIZER, \Memcached::SERIALIZER_JSON);
      self::$_mc->setOption(\Memcached::OPT_CONNECT_TIMEOUT, 2000);

      self::$_mc->addServer(Config::get('cache.memcache.host'), Config::get('cache.memcache.port', 11211));
      return true;
    } else {
  ...
  public static function set(string $key, $value, int $expire=null) :bool {
    ...
    return self::$_mc->set($key, json_encode($value), $expire);
  }
